...
function About() {
    ...
    return (
        <div className={` mt-20 ${isdark ? "text-white" : "text-black"} flex flex-row gap-30 items-center max-w-full justify-between md:px-10 lg:px-15  `}>
            <div>
            ...
            <div className='bg-gray-600/20 rounded-2xl p-10'>

...
function Sections() {
    ...
    return (
        <div className={`flex flex-row justify-between items-center relative top-10 border p-3 rounded-2xl ${isdark ? "bg-slate-800/40" : "bg-white"} border border-gray-500`}>

...
function Sections() {
    ...
    return (
        <div className={`flex flex-row justify-between items-center relative top-10 lg:mx-5 md:mx-10 md:px-5 lg:px-10 rounded-2xl ${isdark ? "bg-slate-800/40" : "bg-white"}`}>
